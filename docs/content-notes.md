...
- Superseded status:
  ...
  Refinement (2026-08-27): the close of this item is really about respecting people's attention, not stewardship of the internet. Attention is the reader's own, and it names what spam and privacy invasion have in common: treating a person as a resource to extract from. Rewrite the close around attention (shape: we'd rather respect people's attention than take it). Distinct from the owner's planned first essay, which is about how working with AI agents fractures one's own attention and how to mitigate that; the site line is about respecting other people's attention. Do not link the two; the site's first writing link is a separate decision once the piece exists.
